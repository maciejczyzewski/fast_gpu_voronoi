...
% XXX
The main question that needs to be addressed is whether JFA has potential
...
\begin{enumerate}
	\item Presenting new envolved state-of-the-art variants of algorithm for Voronoi
		...
		\textbf{\ourjfa} - (Ensemble of Domain-specific) multiple weak variants, production ready; and
...
\hl{czy (Ensemble of Domain-specific) weak variants - jest prawidlowo?}
