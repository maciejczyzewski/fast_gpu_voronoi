...
\begin{figure}[H]
	...
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=0.23\linewidth]{../figures/mod_lnoise_1_in}
		\includegraphics[width=0.23\linewidth]{../figures/mod_lnoise_1_out}
		,
		\includegraphics[width=0.23\linewidth]{../figures/mod_lnoise_2_in}
		\includegraphics[width=0.23\linewidth]{../figures/mod_lnoise_2_out}
