...
% FIXME: a w srodku dwie kolumny i wykresy???????????????????????????
%                   low dense         |       high dense
...
% \begin{figure}[H]
% 	\centering
% 	\includegraphics[width=0.5\linewidth]{../figures/results-small-low/figure-2-loss}
% 	\includegraphics[width=0.5\linewidth]{../figures/results-small-low/figure-3-score}
% 	\caption{bla bla bla}
% 	\label{fig:abstract}
% \end{figure}
