/*
{   'A': 1.6337658976650897,
    'B': 0.9478770593531122,
    'C': 0.9473164798251053,
    'D': 1.2977092647807638,
    'X': 0.4011844129827088,
    'anchor_distance_ratio': 0.5,
    'anchor_double': False,
    'anchor_num': 15,
    'anchor_number_ratio': 0.3333333333333333,
...
#define POS(X, Y) ((X)*y_size + (Y))
    ...
    if (best_seed == 0)
        ...
        for(int i = 0; i < 15; i++) {
            int A = (step * cos((float) ((6.28/15) * i) ));
            int B = (step * sin((float) ((6.28/15) * i) ));
            int nx = x+A;
            int ny = y+B;
